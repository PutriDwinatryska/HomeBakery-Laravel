  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i>  tasteofhome@bakery</li>
          <li>Free shipping for members only</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: Jl. Ketintang Wiyata</li>
                <li>Phone: 089 8834 5436</li>
                <li>Email: tasteofhome@bakery.com</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-md-12">
            <div class="footer__widget">
              ...
              <p>
                Get updates about our new products and special offers
              </p>
              <form action="#">
            ...
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  ...
                  All rights reserved | Taste of Home Bakery
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
